<x-app-layout>
    ...
    <div class="flex" style="height: 91vh;">
        <div class="w-1/2 bg-center bg-cover bg-no-repeat" style="height: 91vh; background-image: url('/assets/dashboard.jpeg');">
    ...
    <section id="order" class="h-screen p-10">
        ...
        <div class="grid grid-cols-4 gap-x-5 p-10">
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
                <a href="#">
                    <img class="p-8 rounded-t-lg" src="{{ asset('/car/Yaris.png') }}" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900">Yaris RS 2020</h5>
                    </a>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900">Rp. 380k/12 jam</span>
                        <a href="#"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Rent</a>
                    </div>
                </div>
            </div>
            @endfor
